...
class TestSparseRetriever:
    def test_add_and_search(self):
        ...
        chunks = [
            Chunk(text="machine learning is a subset of artificial intelligence", doc_id="d1", chunk_index=0),
            Chunk(text="python programming language for data science", doc_id="d2", chunk_index=0),
            Chunk(text="neural networks learn representations from data", doc_id="d3", chunk_index=0),
        ]
